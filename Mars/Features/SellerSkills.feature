...
@AddSkills
Scenario: 1-[Add skills of the Seller on the profile page ]
...
@EditeSkills
Scenario:2-[Edit existing record of the seller on the profil page]
...
@DeleteSkills
Scenario:3-[Delete the skills record sucessfully]
